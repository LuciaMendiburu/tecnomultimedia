class Controlador {
  ...
  Controlador(PApplet pro) {
     ...
     musicaFondo = new SoundFile(pro,"musicaFondo.mp3");
    ...
    //Creo la pantalla 0
    pantalla = 0;
    boton1 = new Boton (textos[0],310, 380, 1, imagenes[19],  textos[28], 2, 2,30, 200,38);
    boton2 = new Boton(textos[1],310,430, 5, imagenes[19],  textos[28], 2, 2,30, 200, 38);
    pantallas[pantalla] = new Pantalla(imagenes[5],imagenes[19], textos[28], textos[28],0, 0,  boton1, boton2, null, null);
    
    //Creo la pantalla 1
    pantalla = 1;
    boton1 = new Boton (textos[5],450, 530,3, imagenes[3],  textos[4], 265, 107,15, 100, 30);
    boton2 = new Boton(textos[7],650,530, 2, imagenes[3],  textos[6], 245, 110,15, 100, 30);
    pantallas[pantalla] = new Pantalla(imagenes[1],imagenes[2], textos[2], textos[3],30, 530,  boton1, boton2, null, null);
      
    //Creo la pantalla 2  
    pantalla = 2;
    boton1 = new Boton (textos[5],450, 530,6, imagenes[7],  textos[28], 265, 107,15, 100, 30);
    boton2 = new Boton(textos[7],650,530, 7, imagenes[8],  textos[28], 245, 110,15, 100, 30);
    pantallas[pantalla] = new Pantalla(imagenes[6],imagenes[2], textos[8], textos[9],30, 540,  boton1, boton2, null, null);
    
    //Creo la pantalla 3  
    pantalla = 3;
    boton1 = new Boton (textos[5],450, 530,4, imagenes[3],  textos[12], 255, 107,15, 100, 30);
    boton2 = new Boton(textos[7],650,530, 2, imagenes[3],  textos[13], 255, 110,15, 100, 30);
    pantallas[pantalla] = new Pantalla(imagenes[1],imagenes[2], textos[10], textos[11],30, 540,  boton1, boton2, null, null);
    //Creo la pantalla 4  
    pantalla = 4;
    
    boton2 = new Boton(textos[1],650,530, 5, imagenes[19],  textos[28], 255, 110,15, 100, 30);
    ...
    boton2 = new Boton(textos[17],650,530, 0, imagenes[19],  textos[28], 255, 110,15, 100, 30);
    ...
    pantalla = 6;
    boton1 = new Boton (textos[28],593, 15,4, imagenes[11],  textos[28], -1, -1, 15, 182, 353);
    ...
    pantalla = 8;
    boton1 = new Boton (textos[28],506, 334,5, imagenes[18],  textos[28], -1, -1,15, 64, 132);
    boton2 = new Boton(textos[28],652,124, 5, imagenes[18],  textos[28], -1, -1,15, 66, 347);
